  ...
  const items = [
    ...
    // },
    {
      ...
      article: [
        {
          type: "Heading2",
          content: "The Importance of Eye Health for Seniors",
        },
        {
          type: "paragraph",
          content:
        ...
        { type: "Heading2", content: "Common Age-Related Eye Conditions" },
        {
          type: "orderedList",
          items: [
            "Cataracts: Clouding of the eye's lens, leading to blurry vision. Surgery is often required to restore clear vision.",
            "Glaucoma: Increased pressure in the eye that can damage the optic nerve, potentially leading to blindness if untreated.",
            "Macular Degeneration: Deterioration of the central part of the retina, affecting sharp central vision needed for activities like reading and driving.",
            "Diabetic Retinopathy: Damage to the blood vessels in the retina due to diabetes, which can cause vision loss.",
          ],
        },
        { type: "Heading2", content: "Tips for Maintaining Healthy Vision" },
        {
          type: "orderedList",
          items: [
            "Regular Eye Exams: Schedule comprehensive eye exams at least once a year to monitor eye health and catch any issues early.",
            "Protect Your Eyes from UV Rays: Wear sunglasses that block 100% of UVA and UVB rays to reduce the risk of cataracts and other eye conditions.",
            "Manage Chronic Conditions: Conditions like diabetes and hypertension can affect your vision. Keep these conditions under control to protect your eyes.",
            "Maintain a Healthy Diet: Foods rich in omega-3 fatty acids, lutein, zinc, and vitamins C and E can help keep your eyes healthy.",
            "Stay Active: Regular exercise improves blood circulation, which can help keep your eyes healthy.",
            "Avoid Smoking: Smoking increases the risk of developing age-related eye conditions.",
          ],
        },
        {
          type: "Heading2",
          content: "The Role of VisionDR in Promoting Eye Health",
        },
        {
          type: "paragraph",
          content:
