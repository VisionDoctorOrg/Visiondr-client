              ...
              <SelectContent className={cn("flex flex-col gap-3 ")}>
                <div className="flex flex-col gap-3 text-left items-start pl-2 py-3 text-gray-950 text-base font-medium leading-normal">
                  <button  className="w-full flex justify-start">
                    <NavLink to="/app/videos/" className="w-full text-left">Recently Added</NavLink>
                  </button>
                  <button className="w-full flex justify-start">
                    <NavLink to="/app/videos/allVideos" className="w-full text-left">
                      All Videos
                    </NavLink>
                  </button>

                  <button className="w-full flex justify-start">
                    <NavLink to="/app/videos/history" className="w-full text-left">History</NavLink>
                  </button>
                </div>
              </SelectContent>
            </Select>
