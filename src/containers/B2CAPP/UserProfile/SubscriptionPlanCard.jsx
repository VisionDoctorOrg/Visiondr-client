...
const SubscriptionPlanCard = ({ title, discription, children, dataContext, tab }) => {
  ...
  return (
    <div onClick={changeTab} className={`xl:w-fit xl:min-w-[240px] w-[245px] grow h-[97px] px-3 py-5 bg-[#d2dbfe]/20 rounded-lg shadow border border-[#d2dbfe] flex-col justify-start items-center gap-10 inline-flex cursor-pointer ${tab == dataContext.billing.tab ? "": "shadow-none bg-white"} `}>
