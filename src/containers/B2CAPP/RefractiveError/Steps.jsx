...
const Steps = ({ steps, stepTitles }) => {
  ...
  return (
    <section className="flex overflow-hidden gap-2 items-center p-6 px-4 pl-5 rounded-lg bg-[#D2DBFE] bg-opacity-20 md:h-[408px] md:max-w-[360px] md:min-w-[270px] md:fixed">
