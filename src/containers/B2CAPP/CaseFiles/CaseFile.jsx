...
function CaseFile() {
  return (
    <DataProvider>
      <main className="flex flex-col text-base md:pl-2 mb-8">
        <h1 className="font-medium text-gray-950 max-md:max-w-full text-base">
          Case File
        </h1>
        <p className="mt-3 text-sm leading-4 text-gray-950 max-md:max-w-full">
