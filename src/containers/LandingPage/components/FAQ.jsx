...
const FAQ = () => {
  return (
    <div className="md:py-10 py-5 w-[80%] md:w-[80%] mx-auto" id="faq">
      <div>
        <h1 className="md:mt-10 md:text-[36px] text-[22px] font-bold text-center">
      ...
      <div className="space-y-4 mx-auto py-10 md:mt-5">
        ...
        <details className="group [&_summary::-webkit-details-marker]:hidden">
          ...
          <p className="mt-3 md:px-4 leading-tight text-[16px] font-medium tracking-tight text-[#0231d9]  pr-5">
            ...
            exceptional, personalized care from experienced professionals,
            utilize advanced technology for urgent advisory sessions, and
            believe in empowering you with knowledge about your eye health. We
            are committed to improving your quality of life through clear
            vision.
          </p>
        </details>
      </div>
